...
public class  VirtualJoystick : MonoBehaviour 
{
	...
	public void Update()
	{
		...
		if (KpadRadius/distance > 3.5f) this.movement = Vector2.zero;
		else
		{
			...
			if (KpadRadius/distance > 1.5f) this.movement /= 2.0f;
		}
